...
Route::middleware(['auth:sanctum', 'tenant', 'audit'])->group(function () {
    ...
    // Audit Logs (Business Owner only)
    Route::prefix('business/audit-logs')->group(function () {
        Route::get('/', [\App\Http\Controllers\Business\AuditLogController::class, 'index']);
        Route::get('/stats', [\App\Http\Controllers\Business\AuditLogController::class, 'stats']);
    });
