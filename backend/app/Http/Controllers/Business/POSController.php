...
class POSController extends Controller
{
    ...
    public function getSale(Sale $sale): JsonResponse
    {
        ...
        $sale->load(['items.product', 'salesman', 'branch']);
        
        // Get maintenance contracts without the problematic visits relationship for now
        $maintenanceContracts = $sale->maintenanceContracts()->get();
