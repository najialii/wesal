...
class MaintenanceController extends Controller
{
    ...
    {
        $user = auth()->user();
        $query = MaintenanceVisit::with(['contract.product', 'contract.sale', 'assignedWorker'])
    ...
    public function dashboard()
    {
        ...
        $todayVisits = MaintenanceVisit::with(['contract.product', 'assignedWorker'])
                                      ->today()
                                      ->get();
    ...
    public function store(Request $request)
    {
        ...
        return response()->json([
            ...
            'visit' => $visit->load(['contract.product', 'assignedWorker']),
        ]);
    }
    ...
    public function completeVisit(Request $request, $id)
    {
        ...
        try {
            ...
            return response()->json([
                ...
                'visit' => $visit->load(['contract.product', 'assignedWorker', 'items.product']),
            ]);
        } catch (\InvalidArgumentException $e) {
            return response()->json(['message' => $e->getMessage()], 400);
        }
    ...
    public function calendar(Request $request)
    {
        ...
        $visits = MaintenanceVisit::with(['contract.product', 'contract.sale', 'assignedWorker'])
        ...
        foreach ($visits as $visit) {
            ...
            $events->push([
                ...
                'worker' => $visit->assignedWorker?->name,
